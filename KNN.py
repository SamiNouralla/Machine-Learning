...
def loadDataset(filename, split, trainingSet=[] , testSet=[]):
    """ Load data from csv file into trainingSet list
    """
...
def getResponse(neighbors):
	...
	# Increment if class of neighbor is a repeat
...
if __name__ == "__main__":
    ...
    testSet=[]
    split = 0.67
    loadDataset('/Users/samimac2/Desktop/PythonProject/testKNN.csv', split, trainingSet, testSet)
